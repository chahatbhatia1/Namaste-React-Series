...
A: ES6 provides us feauture to import & export modules and use it in other files. ES6 provides two ways to export a module from a file: `named export` and `default export`.
...
// ex. giving a named import a different name (alias) by using "as":
...
```
#### Importing: To use state in your component, you need to import `useState` from `react` as shown below:
```jsx
